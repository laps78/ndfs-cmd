...
- Решенные задачи находятся в разных ветках git:
  
  - задача с датой находится в вветке **date-app**
  - задача на угадывание числа находится в ветке **number-guess**

Для избежания конфликтоа симлинк вторая задача линкуется на ___guess___, а первая - на ___cmd___
